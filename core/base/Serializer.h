...
public:
     ...
     * @param enumName The name of the enumeration to write. Ex. "mgp::Camera::Type"
     ...
     * @param defaultValue The default value of the specified property.
     */
    virtual void writeMatrix(const char* propertyName, const Matrix4& value, const Matrix4& defaultValue) = 0;
    ...
    virtual void writeDFloatArray(const char* propertyName, const double* data, size_t count) = 0;
     ...
     *
     * @param propertyName The property to serialize.
     * @param enumName The enumerations name. Ex. "mgp::Camera::Type"
     * @param defaultValue The default value of the specified property.
     ...
     * @return The value that is read.
     */
    virtual Matrix4 readMatrix(const char* propertyName, const Matrix4& defaultValue) = 0;
    ...
    virtual size_t readDFloatArray(const char* propertyName, double** data) = 0;
