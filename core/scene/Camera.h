 ...
 */
class Camera : public Serializable, public Component, public Transform::Listener, public Refable
{
    friend class Node;
...
public:
     ...
     */
    static UPtr<Camera> createPerspective(float fieldOfView, float aspectRatio, float nearPlane, float farPlane);
     ...
     * @return The new Camera.
     */
    static UPtr<Camera> createOrthographic(float zoomX, float zoomY, float aspectRatio, float nearPlane, float farPlane);
