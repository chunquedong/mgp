 ...
 */
class Node : public Transform, public Serializable, public Refable
{
    friend class Scene;
...
public:
     ...
     * @script{create}
     */
    static UPtr<Node> create(const char* id = NULL);

    static UPtr<Node> createForComponent(UPtr<Component> comp, const char* id = NULL);
     ...
     */
    virtual void addChild(UPtr<Node> child);
    virtual void insertChild(UPtr<Node> child);
     ...
     */
    virtual UPtr<Node> removeChild(Node* child);
     ...
     */
    void setDrawable(UPtr<Drawable> drawable);
     ...
     */
    void setLight(UPtr<Light> light);
    ...
    */
     ...
     * @script{create}
     */
    UPtr<Node> clone() const;

    void _addComponent(UPtr<Component> comp);

    template<typename T>
    void addComponent(UPtr<T> comp, bool dirtyBounds = true) {
        removeComponent<T>();
        _addComponent(comp.template dynamicCastTo<Component>());
...
protected:
    ...
    std::list<UPtr<Component> > _components;
};
