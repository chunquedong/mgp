...
UPtr<Camera> Camera::create(Properties* properties)
{
    ...
    else
    {
        ...
        aspectRatio = (float)Toolkit::cur()->getWidth() / Toolkit::cur()->getHeight();
    }
    ...
    case Camera::ORTHOGRAPHIC:
        ...
        camera = createOrthographic(
            properties->exists("zoomX") ? properties->getFloat("zoomX") : Toolkit::cur()->getDpWidth(),
            properties->exists("zoomY") ? properties->getFloat("zoomY") : Toolkit::cur()->getDpHeight(),
            aspectRatio, nearPlane, farPlane);
        break;
    }
