...
protected:
     ...
     */
    AnimationChannel* getChannel(const char* id) const;
...
private:
    ...
    std::vector<AnimationChannel*>* _animationChannels;   // Collection of all animation channels that target the AnimationTarget
