...
Float Frustum::intersectsQuery(const Plane& plane) const
{
    return plane.intersectsQuery(*this);
}

Float Frustum::intersectsQuery(const Ray& ray) const
{
    return ray.intersectsQuery(*this);
}
