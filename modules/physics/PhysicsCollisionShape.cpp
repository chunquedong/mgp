...
PhysicsCollisionShape::~PhysicsCollisionShape()
{
    if (_shape)
    {
        ...
        case SHAPE_MESH:
            ...
            {
                SAFE_FREE(_shapeData.meshData->vertexData);
                SAFE_FREE(_shapeData.meshData->indexData);
...
PhysicsCollisionShape::Definition PhysicsCollisionShape::box(const Vector3& extents, const Vector3& center, bool absolute)
{
    Definition d;
    d.type = SHAPE_BOX;
    d.data.box.extents[0] = extents.x;
    d.data.box.extents[1] = extents.y;
    d.data.box.extents[2] = extents.z;
    //memcpy(d.data.box.extents, &extents.x, sizeof(float) * 3);
    d.data.box.center[0] = center.x;
    d.data.box.center[1] = center.y;
    d.data.box.center[2] = center.z;
...
PhysicsCollisionShape::Definition PhysicsCollisionShape::sphere(float radius, const Vector3& center, bool absolute)
{
    ...
    d.data.sphere.center[0] = center.x;
    d.data.sphere.center[1] = center.y;
    d.data.sphere.center[2] = center.z;
...
PhysicsCollisionShape::Definition PhysicsCollisionShape::capsule(float radius, float height, const Vector3& center, bool absolute)
{
    ...
    d.data.capsule.center[0] = center.x;
    d.data.capsule.center[1] = center.y;
    d.data.capsule.center[2] = center.z;
