...
public:
    ...
    /**
     * Determines if this control accepts focus when moveFocus
     *
     * @return True if this control accepts focus, false if it does not.
     */
     ...
     */
    virtual Form* getTopLevelForm() const;
    ...
    virtual Control* findInputControl(int x, int y, bool focus, unsigned int contactIndex);
...
protected:
     ...
     * @see MotionEvent::MotionType
     */
    virtual bool mouseEvent(MotionEvent::MotionType evt, int x, int y, int wheelDelta);
     ...
     */
    void finishBatch(Form* form, BatchableLayer* batch, RenderInfo* view);
     ...
     */
    virtual unsigned int draw(Form* form, const Rectangle& clip, RenderInfo* view);
