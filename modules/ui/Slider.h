...
public:
     ...
     */
    void setValueTextAlignment(FontLayout::Justify alignment);
     ...
     */
    FontLayout::Justify getValueTextAlignment() const;
...
protected:
     ...
     */
    bool mouseEvent(MotionEvent::MotionType evt, int x, int y, int wheelDelta);
     ...
     */
    //ThemeImage* _minImage;
    
    /**
     * The image for the maximum slider value.
     */
    //ThemeImage* _maxImage;
     ...
     */
    FontLayout::Justify _valueTextAlignment;
