...
UPtr<DepthStencilTarget> DepthStencilTarget::create(const char* id, Format format, unsigned int width, unsigned int height)
{
    ...
    return UPtr<DepthStencilTarget>(depthStencilTarget);
}
